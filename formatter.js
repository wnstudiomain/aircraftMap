...
var UnitLabels = {
    'altitude': { metric: "м", imperial: "ft", nautical: "ft" },
    'speed': { metric: "км/ч", imperial: "mph", nautical: "kt" },
    'distance': { metric: "км", imperial: "mi", nautical: "NM" },
    'verticalRate': { metric: "м/с", imperial: "ft/min", nautical: "ft/min" },
    'distanceShort': { metric: "м", imperial: "ft", nautical: "m" }
};
