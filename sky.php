...
-->
    ...
    <div id="header" class="infoHeading">
        <div class="container">
            ...
            <div class="settingsContainer"><img src="images/settings-icon.png" srcset="images/settings-icon.png 1x, images/settings-icon@2x.png 2x, images/settings-icon@3x.png 3x">
            </div>
        </div>
...
-->
    ...
    <div id="layout_container">
        ...
        <div class="air-menu-wrapper">
            <div class="air-menu">
                <div class="aircraft-header">
                    ...
                    <div class="aircraft-image"><img class="spin-animation" id="image" src="/sky/images/radar.svg" /></div>
                </div>
                <div class="aircraft-data">
                    <div>
                        ...
                        <div class="aircraft-info-wrapper">
                            <a class="about" data-toggle="collapse" href="#about_aircraft" role="button" aria-expanded="false" aria-controls="about_flight"><span>Информация о самолете</span>
                                <span class="arrow">
                            ...
                            <div class="aircraft-info aircraft-info-flight collapse show" id="about_aircraft">
                                ...
                                <div class="aircraft-reg">
                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0)" fill="#004CFF">
                                            <path d="M23.333 32c-4.778 0-8.666-3.888-8.666-8.666 0-4.779 3.888-8.667 8.666-8.667 4.779 0 8.667 3.888 8.667 8.667C32 28.112 28.112 32 23.333 32zm0-16C19.29 16 16 19.291 16 23.334c0 4.042 3.29 7.333 7.333 7.333 4.044 0 7.334-3.29 7.334-7.333S27.377 16 23.332 16z" />
                                            <path d="M22 26.667a.674.674 0 01-.472-.195l-2.666-2.666a.667.667 0 01.942-.943l2.163 2.163 4.197-4.798a.666.666 0 111.004.878l-4.666 5.333a.671.671 0 01-.48.228H22zM12.667 28H3.333A3.337 3.337 0 010 24.667V7.333A3.337 3.337 0 013.333 4H6a.667.667 0 010 1.333H3.333c-1.102 0-2 .898-2 2v17.334c0 1.102.898 2 2 2h9.334a.667.667 0 010 1.333zM22 12a.667.667 0 01-.667-.667v-4c0-1.102-.897-2-2-2h-2.666a.667.667 0 010-1.333h2.666a3.337 3.337 0 013.334 3.333v4A.667.667 0 0122 12z" />
                                            <path d="M15.334 8h-8c-1.103 0-2-.897-2-2V3.333c0-.368.298-.666.666-.666h2.067A3.34 3.34 0 0111.334 0 3.34 3.34 0 0114.6 2.667h2.067c.368 0 .666.298.666.666V6c0 1.103-.897 2-2 2zM6.667 4v2c0 .367.298.667.667.667h8c.367 0 .666-.3.666-.667V4h-2a.667.667 0 01-.666-.667c0-1.102-.898-2-2-2-1.103 0-2 .898-2 2A.667.667 0 018.667 4h-2zM18 12H4.667a.667.667 0 010-1.333H18A.667.667 0 0118 12zM14 16H4.667a.667.667 0 010-1.333H14A.667.667 0 0114 16zM11.333 20H4.667a.667.667 0 010-1.333h6.666a.667.667 0 010 1.333z" />
                                        </g>
                                        <defs>
                                            <clipPath id="clip0">
                        ...
                        <div class="aircraft-info-wrapper">
                            <a class="about collapsed" data-toggle="collapse" href="#about_flight" role="button" aria-expanded="false" aria-controls="about_flight"><span id="flight-text">Подробнее о рейсе </span><span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                                    </svg></span></a>
                            <div id="about_flight" class="arrival-info collapse aircraft-info">
                                ...
                                <div>
                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M29.5 30.5V28a.5.5 0 00-.5-.5h-.5v-17h.5a.5.5 0 00.5-.5V1a.5.5 0 00-.5-.5H3a.5.5 0 00-.5.5v9a.5.5 0 00.5.5h.5v17H3a.5.5 0 00-.5.5v2.5h-2v1h31v-1h-2zm-26-21v-2h4v2h-4zm4 3h1v13h-1v-13zm.5 15h-.5v-1H9a.5.5 0 00.5-.5V12a.5.5 0 00-.5-.5H7.5v-1H8a.5.5 0 00.5-.5V7.5h15V10a.5.5 0 00.5.5h.5v1H23a.5.5 0 00-.5.5v14a.5.5 0 00.5.5h1.5v1H24a.5.5 0 00-.5.5v2.5h-15V28a.5.5 0 00-.5-.5zm16.5-2h-1v-13h1v13zm0 3h4v2h-4v-2zm3-1h-2v-17h2v17zm-3-18v-2h4v2h-4zm-21-8h25v5h-25v-5zm1 9h2v17h-2v-17zm-1 18h4v2h-4v-2z" fill="#004CFF" />
                                        <path d="M16 2.5c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5 1.5-.673 1.5-1.5-.673-1.5-1.5-1.5zm0 2a.5.5 0 110-1 .5.5 0 010 1zM20 2.5c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5 1.5-.673 1.5-1.5-.673-1.5-1.5-1.5zm0 2a.5.5 0 110-1 .5.5 0 010 1zM12 2.5c-.827 0-1.5.673-1.5 1.5s.673 1.5 1.5 1.5 1.5-.673 1.5-1.5-.673-1.5-1.5-1.5zm0 2a.5.5 0 110-1 .5.5 0 010 1zM10.269 17.548l1.998-1 .447.894-1.998 1-.447-.894zM10.266 20.448l.447-.894 1.999 1-.447.894-2-1zM19.265 17.452l.447-.894 2 1-.448.894-1.999-1zM19.264 20.549l2-1 .446.894-1.999 1-.447-.894z" fill="#004CFF" />
                                    </svg>
                        ...
                        <div class="aircraft-info-wrapper">
                            <a class="about collapsed" data-toggle="collapse" href="#about_flight-data" role="button" aria-expanded="false" aria-controls="about_flight-data"><span>Данные полета</span>
                                <span class="arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                                    </svg>
                            ...
                            <div class="aircraft-info collapse flight-data-aircraft" id="about_flight-data">
                                <div class="aircraft_sitedist">
                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M25.455 0a5.097 5.097 0 00-5.091 5.09c0 2.436 3.607 7.364 4.453 8.486 0 .362 0 .718-.01 1.044a.637.637 0 00.62.653h.018a.637.637 0 00.636-.62c.008-.334.008-.7.008-1.073.84-1.114 4.457-6.051 4.457-8.49A5.097 5.097 0 0025.454 0zm0 12.299c-1.4-1.925-3.818-5.588-3.818-7.208a3.822 3.822 0 013.818-3.818 3.822 3.822 0 013.818 3.818c0 1.62-2.42 5.283-3.818 7.208z" fill="#004CFF" />
                                        <path d="M25.455 3.818c-.702 0-1.273.571-1.273 1.273s.571 1.273 1.273 1.273c.701 0 1.273-.571 1.273-1.273s-.572-1.273-1.273-1.273zM7.637 14a3.822 3.822 0 00-3.819 3.818 3.822 3.822 0 003.819 3.818 3.822 3.822 0 003.818-3.818A3.822 3.822 0 007.637 14zm0 6.364a2.548 2.548 0 01-2.546-2.546 2.548 2.548 0 012.546-2.545 2.548 2.548 0 012.545 2.545 2.548 2.548 0 01-2.545 2.546zM17.276 22.935a.635.635 0 00-.823.364c-.286.737-.642 1.596-1.123 2.384a.637.637 0 001.086.663c.533-.873.918-1.798 1.224-2.587a.637.637 0 00-.364-.824zM13.687 27.58c-.638.505-1.362.885-2.216 1.163a.636.636 0 10.394 1.21 8.33 8.33 0 002.612-1.376.637.637 0 00-.79-.998zM19.479 18.34c-1.05.597-1.634 1.631-1.982 2.357a.636.636 0 101.147.55c.442-.92.893-1.476 1.464-1.8a.636.636 0 10-.63-1.106zM25.218 16.765a.638.638 0 00-.884.17c-.209.31-.638.736-1.935.852a.636.636 0 10.114 1.267c1.378-.123 2.318-.583 2.875-1.405a.636.636 0 00-.17-.884z" fill="#004CFF" />
                                        <path d="M9.144 29.28c2.008-2.14 6.129-7.067 6.129-11.462 0-4.282-3.355-7.636-7.637-7.636C3.355 10.182 0 13.536 0 17.818c0 5.683 6.906 12.275 7.2 12.553.122.117.28.174.436.174.464 0 .905-.016 1.322-.048a.636.636 0 00.587-.682.625.625 0 00-.4-.534zm-1.508-.268c-1.503-1.534-6.363-6.831-6.363-11.194 0-3.568 2.795-6.364 6.363-6.364 3.569 0 6.364 2.796 6.364 6.364 0 4.363-4.86 9.66-6.364 11.194z" fill="#004CFF" />
                                    </svg>
                                    <span title="Расстояние между самолетом и ADS-B радаром">Расстояние от радара </span>
                                    <span id="aircraft_sitedist">N/A</span>
                                </div>
                                <div class="aircraft_altitude">
                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M25.74 15.215L20.015 4.378a.781.781 0 00-.69-.417h-.002a.78.78 0 00-.69.413l-5.245 9.791a.468.468 0 00.04.505l1.284 1.684a.78.78 0 001.206.047l2.03-2.272 3.946 4.659a.782.782 0 00.59.276h.007c.226 0 .44-.097.588-.266l2.34-2.667a.473.473 0 00.036-.049l.26-.388a.468.468 0 00.025-.479zm-1.046.322l-2.201 2.51-3.945-4.658a.782.782 0 00-.587-.276h-.01a.782.782 0 00-.584.26l-2.023 2.266-.99-1.297 4.968-9.272 5.46 10.336-.088.13z" fill="#004CFF" />
                                        <path d="M31.908 26.891l-3.674-6.956a.468.468 0 10-.828.437l3.556 6.731H18.496c-.015-.072-5.432-10.351-5.432-10.351l.805-1.503.843 1.105a.78.78 0 001.206.047l2.03-2.272 3.946 4.659a.782.782 0 00.59.277h.007c.225 0 .44-.097.588-.267l.005-.005 2.151-2.53.875 1.656a.468.468 0 10.827-.438L20.015 4.378a.781.781 0 00-.69-.417h-.002a.78.78 0 00-.69.413l-4.914 9.174-.332.617-.85 1.589-2.53-4.788a.78.78 0 00-.69-.417h-.031l-.024.001-.021.003-.032.003-.028.005a.781.781 0 00-.556.401L6.912 14.16l-2.881 5.378-.002.003-3.935 7.346a.777.777 0 00.018.772c.143.238.394.38.671.38h30.433a.777.777 0 00.67-.378.776.776 0 00.022-.77zM14.496 14.078l4.826-9.007 5.442 10.301-2.273 2.673-3.943-4.655a.782.782 0 00-.587-.277h-.01a.782.782 0 00-.584.261l-2.024 2.265-.988-1.297.141-.264zM1.04 27.103l3.544-6.615 1.366 1.144a.78.78 0 001.087-.079l1.567-1.756 1.01 1.001a.468.468 0 00.659-.664l-1.124-1.116a.786.786 0 00-1.135.035l-1.576 1.766-1.402-1.174 4.278-7.987 5.521 10.451-1.333 1.229-1.219-1.21a.468.468 0 10-.66.665l1.324 1.313a.78.78 0 001.082.02l1.259-1.16 2.186 4.137H1.04z" fill="#004CFF" />
                                    </svg>
                                ...
                                <div class="aircraft_position">
                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0)" fill="#004CFF">
                                            <path d="M32 14.933c0-.588-.478-1.066-1.067-1.066H28.62A12.79 12.79 0 0018.133 3.38V1.067c0-.59-.477-1.066-1.066-1.067h-2.134c-.588 0-1.066.478-1.066 1.067V3.38A12.79 12.79 0 003.38 13.867H1.067c-.59 0-1.066.477-1.067 1.066v2.134c0 .588.478 1.066 1.067 1.066H3.38A12.79 12.79 0 0013.867 28.62v2.313c0 .59.477 1.066 1.066 1.067h2.134c.588 0 1.066-.478 1.066-1.067V28.62A12.79 12.79 0 0028.62 18.133h2.313c.59 0 1.066-.477 1.067-1.066v-2.134zm-1.067 2.134H28.16a.533.533 0 00-.529.464 11.722 11.722 0 01-10.1 10.1.533.533 0 00-.464.529v2.773h-2.134V28.16a.533.533 0 00-.464-.529 11.722 11.722 0 01-10.1-10.1.533.533 0 00-.529-.464H1.067v-2.134H3.84a.533.533 0 00.529-.464 11.722 11.722 0 0110.1-10.1.533.533 0 00.464-.529V1.067h2.134V3.84c0 .268.199.494.464.529 5.266.69 9.41 4.834 10.1 10.1.035.265.261.464.529.464h2.773v2.134z" />
                                            <path d="M16 6.4A9.6 9.6 0 006.4 16a9.6 9.6 0 009.6 9.6 9.6 9.6 0 009.6-9.6A9.612 9.612 0 0016 6.4zm0 18.134A8.533 8.533 0 1124.534 16 8.543 8.543 0 0116 24.535z" />
                                            <path d="M16 11.2a4.8 4.8 0 100 9.6 4.8 4.8 0 000-9.6zm0 8.534a3.734 3.734 0 110-7.468 3.734 3.734 0 010 7.468z" />
                                        </g>
                                        <defs>
                                            <clipPath id="clip0">
                                                <path fill="#fff" d="M0 0h32v32H0z" />
                        ...
                        <div class="aircraft-info-wrapper">
                            <a class="about collapsed" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1"><span>Информация об отслеживании</span><span class="arrow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                                    </svg></span></a>
                            <div id="collapseExample1" class="arrival-info-tracking aircraft-info arrival-info collapse">
                                ...
                                <div>Squawk <span title="4-значный восьмеричный код, присвоенный самолету Управлением воздушного движения." id="aircraft_source_squawk">N/A</span></div>
                                <div>Сообщений <span title="Общее количество сообщений, полученных с самолета" id="aircraft_source_mes">N/A</span>
                                </div>
                                <div>RSSI <span title="Мощность сигнала, полученная ADS-B с самолета." id="aircraft_source_rssi">N/A</span></div>
                            </div>
                        </div>
        ...
        <div id="settings_infoblock">
            <div id="settings_close" class="settingsCloseBox">
                <svg width="16" height="16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0)">
                        <path d="M8.884 8.001l6.933-6.933a.625.625 0 10-.884-.884L8 7.117 1.067.184a.625.625 0 10-.884.884L7.116 8 .183 14.934a.625.625 0 10.884.884L8 8.885l6.933 6.933a.623.623 0 00.884 0 .625.625 0 000-.884L8.884 8.001z" fill="#fff" />
                    </g>
                    <defs>
                        <clipPath id="clip0">
            ...
            <div class="settingsOptionContainer settingsTitle">
                <div class="infoBlockTitleText">Настройки отображения</div>
            </div>
            <div class="settingsColumn">
                ...
                <div class="settingsOptionContainer">
                    ...
                    <div class="settingsText">Отобразить маршрут самолета</div>
                </div>
                <div class="settingsOptionContainer">
                    <div class="settingsCheckbox" id="acpositions_checkbox"></div>
                    <div class="settingsText">Отобразить самолеты на карте</div>
                </div>
                <div class="settingsOptionContainer">
                    <div class="settingsCheckbox" id="selectall_checkbox"></div>
                    <div class="settingsText">Отобразить все маршруты самолетов на карте</div>
                </div>
                <div class="button buttonHeader" onclick="resetMap();"><span class="buttonText">Сбросить карту</span></div>
            </div>
        </div>
        ...
        <div id="map_container">
            ...
            <div class="right-nav">
                ...
                <div id="toggle_sidebar_control" class="ol-unselectable ol-control">
                    <button id="toggle_sidebar_button" class="show_sidebar toggle_sidebar_button" title="Информация о бортах"></button>
                    <a title="Настройки отображения" class="toggle_settings" id="toggle_settings"><img src="/sky/images/settings 1.svg" /> </a>
                    <a title="Режим день/ночь" id="change-layer" data-layer='basic_layer' class="change-layer"><img src="/sky/images/night (1).svg" /> </a>
                    <a href="sky.php?do=logout" title="Выход" id="sign-out" class="sign-out"><img src="/sky/images/logout (1).svg" /> </a>
            ...
            <div id="sidebar_canvas">
                ...
                <div id="dump1090_infoblock">
                    <table style="width: 100%">
                        ...
                        <td><span class="infoBlockTitleText">Прием сообщений:</span> <span id="dump1090_message_rate">n/a</span>/сек
                            <td><span class="infoBlockTitleText">Накоплено:</span> <span id="dump1090_total_history">n/a</span> позиций
                            </td>
                        </tr> -->
                    </table>
                        ...
                        <table id="tableinfo" class="table">
                            <thead class="aircraft_table_header">
                                <tr>
                                    ...
                                    <td id="altitude" onclick="sortByAltitude();">Высота (<span class="altitudeUnit"></span>)
                                    </td>
                                    <td id="speed" onclick="sortBySpeed();">Скорость (<span class="speedUnit"></span>)</td>
                                    <td id="vert_rate" onclick="sortByVerticalRate();">Vertical Rate (<span class="verticalRateUnit"></span>)
                                    </td>
                                    <td id="distance" onclick="sortByDistance();">Расстояние (<span class="distanceUnit"></span>)
                                    </td>
                ...
                <div class="infoblock-container">
                    ...
                    <div class="infoBlockTopSection">
                        ...
                        <div class="infoRow removePadding">
                            <div class="infoHeading infoRowFluid"><span title="The alphanumeric registration code assigned by the country in which the aircraft is registered.">Зарегистрировано</span>:
                            </div>
    ...
    <div class="nav-bottom">
        ...
        <div class="air-info">
            <svg width="30" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)" filter="url(#filter0_d)" fill="#fff">
                    <path d="M17.75 11.916a.916.916 0 00-.917.917V16.5c0 .505-.41.916-.916.916h-2.75V3.666c0-.782-.5-1.482-1.249-1.742l-.271-.09h4.27c.505 0 .916.41.916.916V5.5a.916.916 0 101.834 0V2.75A2.753 2.753 0 0015.916 0H6.061c-.034 0-.064.016-.098.02C5.92.016 5.878 0 5.834 0A1.835 1.835 0 004 1.833v16.5c0 .783.499 1.482 1.248 1.743l5.517 1.838c.187.058.373.086.568.086a1.835 1.835 0 001.833-1.834v-.916h2.75a2.753 2.753 0 002.75-2.75v-3.667a.916.916 0 00-.916-.917z" />
                    <path d="M25.731 8.518l-3.667-3.666A.916.916 0 0020.5 5.5v2.75h-3.667a.917.917 0 000 1.833H20.5v2.75a.918.918 0 001.564.648l3.667-3.666a.916.916 0 000-1.297z" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <path fill="#fff" transform="translate(4)" d="M0 0h22v22H0z" />
                    </clipPath>
        ...
        <div class="air-table toggle_sidebar_button">
            <svg width="25" height="25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M.265 13.094l3.439 1.42-.73.34a.436.436 0 00-.204.56l.99 2.129a.434.434 0 00.245.225.424.424 0 00.333 0l7.537-3.535.095-1.003.132-1.341a.322.322 0 01.615-.104c.028.049.04.107.036.165l-.874 9.256c.196.144.44.196.677.15.333-.088.629-.477.874-1.118l3.496-10.405.1-.295a.328.328 0 11.63.185c-.005.009-.006.017-.01.024l-.34.997-.384 1.145 5.902-2.765c1.705-.797 2.581-2.41 1.993-3.667a2.21 2.21 0 00-1.708-1.193 4.06 4.06 0 00-2.387.367l-6.684 3.12-7.175-2.802c-.904-.34-1.621-.331-2.123.032-.421.345-.66.865-.651 1.411a.438.438 0 00.187.344l4.834 3.312-2.771 1.311-4.645-1.162a.44.44 0 00-.485.209L.056 12.478a.436.436 0 00.167.594c.014.009.029.015.042.022z" fill="#fff" />
            </svg>
        </div>
        <div title="Режим день/ночь" id="change-layer" data-layer='basic_layer' class="change-layer change-layer-mobile">
            <svg width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.38 17.032c-1.064.352-2.17.53-3.291.53-5.776 0-10.476-4.698-10.476-10.476 0-2.331.752-4.54 2.175-6.386a.245.245 0 00.005-.29.243.243 0 00-.274-.09A10.942 10.942 0 000 10.728c0 6.045 4.918 10.964 10.963 10.964a10.89 10.89 0 008.686-4.28.243.243 0 00-.269-.38zM13.983 6.482l1.61-1.169 1.608 1.17-.615-1.892 1.609-1.169h-1.988l-.614-1.89-.614 1.89h-1.99l1.609 1.17-.615 1.89zM22 6.861h-.814l-.252-.774-.252.774h-.813l.657.48-.25.773.658-.478.658.478-.25-.774.658-.479z" fill="#fff" />
            </svg>
        </div>
